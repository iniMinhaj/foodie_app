...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadProfile() async {
    ...
    try {
      ...
      final profile = UserProfileModel.fromJson(json['data'] as Map<String, dynamic>);
      if (!mounted) return;
      setState(() {
        _profile = profile;
        _isLoading = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _hasError
          ? ErrorStateView(message: 'Could not load your profile.', onRetry: _loadProfile)
          : _isLoading
      ...
      children: [
        ...
        for (final address in profile.addresses)
          ListTile(
            ...
            leading: Icon(address.isDefault ? Icons.home_rounded : Icons.location_on_outlined, color: AppColors.primary),
